 ...
 *
 * Lazy, via `loadComponent`. Eight pages of which one is built; eagerly importing
 * the lot would put every page's code in the initial bundle for the sake of the
 * one the user opened.
 */
